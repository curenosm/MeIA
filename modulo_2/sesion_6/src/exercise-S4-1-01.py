#!/usr/bin/python3
#   Example S2-2-03: Virtual Adversarial Domain Adaptation (VADA)
#   Commands to execute this code:
#   python3.8 exercise-S4-1-01.py --dir_resume outputs --seed 223
